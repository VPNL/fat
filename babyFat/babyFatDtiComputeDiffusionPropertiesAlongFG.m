...
if ~notDefined('roi1') && ~notDefined('roi2')
    ...
    [myValsFgWa, SuperFiber, fgResampled] = ...
       babyFatDtiFiberGroupPropertyWeightedAverage(fgClipped, dt, numberOfNodes, valname, dFallOff);
else
    % compute weighted averages for eigenvalues along full fiber tract
    [myValsFgWa, SuperFiber, fgResampled] = ...
        babyFatDtiFiberGroupPropertyWeightedAverage(fg, dt, numberOfNodes, valname, dFallOff);

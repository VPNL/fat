function [myValsFgWa, SuperFiber, weightsNormalized, weights, fgResampled] = ...
    babyFatDtiFiberGroupPropertyWeightedAverage(fg, dt, numberOfNodes, valNames, p)
...
if strcmp(valNames,'image');
    [myVals] = babyFatDtiGetValFromImage(dt.data, fc, dt.qto_ijk);
else
    [myVals1,myVals2, myVals3, myVals4, myVals5, myVals6, myVals7] = ...
        babyFatDtiGetValFromTensors(dt.dt6, fc, inv(dt.xformToAcpc), valNames);

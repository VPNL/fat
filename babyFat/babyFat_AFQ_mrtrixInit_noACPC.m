...
%         system(cmdstr)
   ...
   %%% change this back to brainMask_acpc!!!!     
cmd_str=['mri_convert ' fullfile(anatFolder,'brainMask.nii.gz') ' ',...
...
%     if (~computed.('wmResponseMSMT5tt')) && (mrtrixVersion > 2)
%         cmd_str = ['dwi2response msmt_5tt -force ' ...
%             files.dwi ' ' ...
%             files.tt5 ' ' ...
%             files.wmResponseMSMT5tt  ' ' ...
%             files.gmResponseMSMT5tt  ' ' ...
%             files.csfResponseMSMT5tt ' ' ...
%             '-grad ' files.b  ' ' ...
%             '-voxels ' files.voxelsMSMT5tt ' ' ...
%             '-mask ' files.brainmask ' ' ...
%             '-fa  0.1'];
%         [status,results] = AFQ_mrtrix_cmd(cmd_str, 0, 1, mrtrixVersion);
%     end
%     
%        if (~computed.('wmResponseTournier'))
%         cmd_str = ['dwi2response dhollander -force ' ...
%             files.dwi ' ' ...
%             files.wmResponseTournier  ' ' ...
%             files.gmResponseDhollander  ' ' ...
%             files.csfResponseDhollander ' ' ...
%             '-mask ' files.brainmask_eroded ' ' ...
%             '-grad ' files.b  ' ' ...
%             '-voxels ' files.voxelsTournier ' ' ...
%             '-wm_algo tournier ' ... 
%             '-fa 0.1'];
%         [status,results] = AFQ_mrtrix_cmd(cmd_str, 0, 1, mrtrixVersion);
%         end

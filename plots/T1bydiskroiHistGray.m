...
%     '17_ad_qMRI_081817' '18_nc_qMRI_090817'}
% % get ROI
roiList = {'dti_lh_IFG_ISMG_SLF_unique_no_gray.mat' 'dti_lh_IPCS_ISMG_SLF_unique_no_gray_dilated.mat'...
...
hold on
p3=shadedErrorBar([],histmean(:,3),histse(:,3),[0 0 1],0.5)
hold on
p4=shadedErrorBar([],histmean(:,4),histse(:,4),[0 1 0],0.5)
hold on
p3=shadedErrorBar([],histmean(:,5),histse(:,5),[0 0 1],0.5)
hold on
p4=shadedErrorBar([],histmean(:,6),histse(:,6),[0 1 0],0.5)
hold on
...
set(gca,'XTick',[1:5:length(edges)])
set(gca,'XTickLabel',[0.75:0.05:2]);

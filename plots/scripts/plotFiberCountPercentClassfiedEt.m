...
ROIs={'OTS_union_morphing_reading_vs_all'}
...
caption_x=['lh'; 'rh'];
caption_y='betas';
fig=mybar(xvalues,xerror, caption_x,[],[[0.9 0.5 0];[0.9 0.5 0];[0.8 0 0];[0.8 0 0];[0.8 0 0.8];[0.8 0 0.8];[0 0 0.8];[0 0 0.8];[0 0.8 0.8];[0 0.8 0.8];[0 0.8 0];[0 0.8 0]],2,0.8);
if a==1
ylim([0 100]);
elseif a==2
    ylim([0 100]);
...
ylabel('% relative to all classified fibers in ROI','FontSize',16,'FontName','Arial','FontWeight','bold');
xlabel(['IFOF   ILF    SLF    AF    pAF   VOF'],'FontSize',16,'FontName','Arial','FontWeight','bold');
pbaspect([1 1 1])

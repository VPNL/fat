...
OutDir=fullfile(ExpDir,'dti_results_new_reading_ROIs_v2');
    ...
    for l=1:length(input_ROIs)
        if l==1
            ROIs={'lh_aSTS_morphing_reading_vs_all.mat' 'lh_pSTS_MTG_union_morphing_reading_vs_all.mat'...
                'lh_ISMG_morphing_reading_vs_all.mat' 'lh_IFG_union_morphing_reading_vs_all.mat' 'lh_ORS_morphing_reading_vs_all.mat'}
        elseif l==2
            ROIs={'lh_pSTS_MTG_union_morphing_reading_vs_all.mat' 'lh_ISMG_morphing_reading_vs_all.mat' 'lh_IFG_union_morphing_reading_vs_all.mat' 'lh_ORS_morphing_reading_vs_all.mat'}
        elseif l==3
            ROIs={'lh_ISMG_morphing_reading_vs_all.mat' 'lh_IFG_union_morphing_reading_vs_all.mat' 'lh_ORS_morphing_reading_vs_all.mat'}
        elseif l==4
            ROIs={'lh_IFG_union_morphing_reading_vs_all.mat' 'lh_ORS_morphing_reading_vs_all.mat'}
        elseif l==5
            ROIs={'lh_ORS_morphing_reading_vs_all.mat'}
        elseif l==6
            ROIs={}
        end

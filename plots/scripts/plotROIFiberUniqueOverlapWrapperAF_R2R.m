...
for s=1:length(sessid)
    for r=1:length(runName)
        ...
        fiberUnique1=fullfile(runDir,'mrtrix','lh_IFG2STS_lmax12_select100.tck');
        
        fiberUnique2=fullfile(runDir,'mrtrix','lh_IPCS2ITG_lmax12_select100.tck');
        ...
        if (exist(fiberUnique1) && exist(fiberUnique2))
            ...
            roifg=output_roifg;
            save(fullfile(runDir,'fibers','afq','lh_STS_ITG_IPCS_IFG_AF_overlap_R2R.mat'),'roifg');
            clear('roifg');
            clear('output_roifg');
            ROIfg=['lh_STS_ITG_IPCS_IFG_AF_overlap_R2R.mat'];
 ...
 imgName=['lh_STS_ITG_IPCS_IFG_AF_overlap_R2R.tiff'];

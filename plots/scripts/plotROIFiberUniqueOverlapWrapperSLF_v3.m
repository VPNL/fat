...
for s=1:20
    for r=1:length(runName)
        ...
        fiberUnique1=fullfile(runDir,'fibers','afq','lh_ISMG_morphing_reading_vs_all_projed_gmwmi_lh_IFG_union_morphing_reading_vs_all_projed_gmwmi_r1.00_WholeBrainFGRoiSe_classified_clean_overlap_unique.mat');
        
        fiberUnique2=fullfile(runDir,'fibers','afq','lh_ISMG_morphing_adding_vs_all_projed_gmwmi_lh_IPCS_morphing_adding_vs_all_projed_gmwmi_r1.00_WholeBrainFGRoiSe_classified_clean_overlap_unique.mat');
        
        fiberOverlap=fullfile(runDir,'fibers','afq','lh_ISMG_morphing_reading_vs_all_projed_gmwmi_lh_IFG_union_morphing_reading_vs_all_projed_gmwmi_lh_ISMG_morphing_adding_vs_all_projed_gmwmi_lh_IPCS_morphing_adding_vs_all_projed_gmwmi_r1.00_WholeBrainFGRoiSe_classified_clean_overlap_overlap.mat');
        ...
        if (exist(fiberUnique1) && exist(fiberUnique2))
            ...
            roifg=output_roifg;
            save(fullfile(runDir,'fibers','afq','lh_ISMG_IPCS_IFG_SLF_overlap_IFOD1.mat'),'roifg');
            clear('roifg');
            clear('output_roifg');
            ROIfg=['lh_ISMG_IPCS_IFG_SLF_overlap_IFOD1.mat'];
 ...
 imgName=['lh_ISMG_IPCS_IFG_SLF_overlap_IFOD1.tiff'];

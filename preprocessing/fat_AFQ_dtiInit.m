function [dt6FileName, outBaseDir] = AFQ_dtiInit(dwRawFileName, t1FileName, dwParams)
...
if doResampleRaw,  fatdtiRawResample(dwRaw, dwDir.ecFile, dwDir.acpcFile,...
...
binDirName  = fullfile(outBaseName, 'mrtrix');
...
files.wmMask    = fullfile(pBinDir,'wmMask_from_FreeSurfer.nii.gz');

...
% %                  '| mrmath - mean ' files.b0 ' -axis 3 -quiet'];
    ...
    cmd_str1 = ['dwiextract -bzero -force -grad ' files.b ' -singleshell ' ...
        '-shells 0,' num2str(singleShell) ' -export_grad_mrtrix ' files.bSS ' ' ...
        files.dwi ' ' files.dwiSS];
    cmd_str2 = ['mrmath ' files.dwiSS ' mean ' files.b0 ' -axis 3 -quiet -force'];
...
%     '| mrmath - mean ' files.b0 ' -axis 3 -quiet'];  
    ...
    cmd_str1 = ['dwiextract -bzero -grad ' files.b ' ' files.dwi ' ' files.dwiSS];
    cmd_str2 = ['mrmath ' files.dwiSS ' mean ' files.b0 ' -axis 3 -quiet -force'];
    [status,results] = AFQ_mrtrix_cmd(cmd_str1,bkgrnd,verbose,mrtrixVersion);
    [status,results] = AFQ_mrtrix_cmd(cmd_str2,bkgrnd,verbose,mrtrixVersion);
end
